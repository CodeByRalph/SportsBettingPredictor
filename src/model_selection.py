...
# feature imports
from src.features.qb_features.yds import add_passing_yds_features
...
def preprocess_data(df, target_stat):
    ...
    df = add_passing_yds_features(df)
    ...
    # Apply Recursive Feature Elimination (RFE) to select top `num_features`
    rfe_model = RandomForestRegressor()  # You can use another estimator like XGBRegressor
